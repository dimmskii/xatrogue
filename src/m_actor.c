...
void actor_files ()
{
	...
	for(i=game.maxclients+1; i<globals.num_edicts; i++)
	{
		...
		for(k=0; k<2; k++)
		{
			...
			case 11:strcat(filename,"w_ripper.md2");		break;
			case 12:strcat(filename,"w_phalanx.md2");		break;
			case 13:strcat(filename,"w_etfrifle.md2");		break;
			case 14:strcat(filename,"w_plasma.md2");		break;
			case 15:strcat(filename,"w_disrupt.md2");		break;
			// end Knightmare
