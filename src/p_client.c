...
void InitClientPersistant (gclient_t *client, int style)
{
	...
	client->pers.max_fc_health	= max_foodcube_health->value;
	...
	client->pers.max_shockspheres		= max_shocksphere->value;
	client->pers.max_homing_rockets = max_rockets->value;
...
//ROGUE
	...
	client->pers.max_disruptors = max_rounds->value;
//ROGUE
