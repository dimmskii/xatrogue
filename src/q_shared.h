...
#define _mkdir(a)	mkdir(a, 0777) // DIMCOMMENT Again, I don't know. Taken from KDQ2 main game source. Was missing here.
...
#define RF_FILTERSHADOW		0x00100000 // Knightmare- filter shadow flag
