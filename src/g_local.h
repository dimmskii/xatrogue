...
//extern	int	jacket_armor_index; // DIMCOMMENT
//extern	int	combat_armor_index; // DIMCOMMENT
//extern	int	body_armor_index; // DIMCOMMENT
...
//
void PlayerNoise(edict_t *who, vec3_t where, int type);
//void P_ProjectSource (gclient_t *client, vec3_t point, vec3_t distance, vec3_t forward, vec3_t right, vec3_t result); // DIMCOMMENT
